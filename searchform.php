<form id="search" name="searchform" method="get" action="<?php bloginfo("url"); ?>">
	<section id="searchOptions" class="wrapper">
		...
		<div class="search-options">
			...
			<input type="radio" value="events" name="post_type" id="searchOptionsEvents" data-searchtext="Search for district events..." /> <label for="searchOptionsEvents">Search Events</label>
